...
<div class="main_div">
 ...
 <div class="navbar navbar-expand-md">
  ...
  <a href="index.php" class="navbar-brand font-weight-bold text-white text-center"><h2>SPARKS BANK</h2></a>
 ...
 <img src = "A.jpg" alt="image" class = 'center' width = 65% height = 70% style="margin-top:20px;">
 <br>
 <h2 align = 'Center' style="color:black;"><u>List of Customers</u></h2>
</div>
    <?php
    include 'connect.php';
